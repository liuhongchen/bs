package com.liuhongchen.${package}.client;
import com.liuhongchen.${package}.pojo.${table.className};

import com.liuhongchen.fallback.${table.className}ClientFallBack;
