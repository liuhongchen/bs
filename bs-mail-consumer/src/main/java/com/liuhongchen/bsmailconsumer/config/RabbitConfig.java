package com.liuhongchen.bsmailconsumer.config;
 ...
 * Package:com.liuhongchen.bsmailprovider.config
 * Description:
 *
    ...
    public RabbitTemplate rabbitTemplate() {
        ...
        rabbitTemplate.setConfirmCallback((correlationData, ack, cause) -> {
            if (ack) {
                ...
                msgLogService.updateStatus(msgId, Constants.MsgLogStatus.DELIVER_SUCCESS);
            } else {
